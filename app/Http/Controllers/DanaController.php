...
class DanaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('template.dana.index', compact('titlePage', 'navigation', 'dataDana', 'inflow', 'outlay'));
    }
    ...
    public function create()
    {
        ...
        $navigation = "active";
        return view('template.dana.add', compact('titlePage', 'navigation'));
    }
    ...
    public function edit(Dana $dana)
    {
        $titlePage = "Edit Dana";
        $navigation = "active";
        return view('template.dana.edit', compact('dana', 'titlePage', 'navigation'));
    }
    ...
    {
        $validatedData = $request->validate([
            'bukti_nota' => 'image|mimes:jpg,png,jpeg|max:1000',
        ]);
