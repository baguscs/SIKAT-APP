                ...
                <form class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data" action="{{ route('aduan.update', $aduan->id) }}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required="" name="judul" value="{{ $aduan->judul }}">
                            <div class="invalid-feedback">Judul aduan apa?</div>
                        </div>
                        <div class="form-group">
                            <label>Isi Aduan</label>
                            <textarea name="isi" id="" cols="30" rows="10" class="form-control" required>{{ $aduan->isi }}</textarea>
                            <div class="invalid-feedback">Rincian agendanya?</div>
                        </div>
                        <div class="form-group">
                            <label>Bukti Aduan</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input image" id="customFile" name="bukti">
                        ...
                        <div class="col-md-12 mb-2">
                            <a href="{{ asset('storage/aduan/'. $aduan->bukti) }}" target="_blank"><img id="preview-image-before-upload" src="{{ asset('storage/aduan/'. $aduan->bukti) }}"
