                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_warga" class="form-control" value="{{ $warga->nama_warga }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="tempat_lahir" value="{{ $warga->tempat_lahir }}">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="text" class="form-control" required name="alamat" value="{{ $warga->alamat }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required name="no_telp" value="{{ $warga->no_telp }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control required" name="jenis_kelamin" required>
                                        ...
                                        <option value="Pria" {{ $warga->jenis_kelamin == "Pria" ? 'selected' : '' }}>Pria</option>
                                        <option value="Wanita" {{ $warga->jenis_kelamin == "Wanita" ? 'selected' : '' }}>Wanita</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="pekerjaan" value="{{ $warga->pekerjaan }}">
                            ...
                            <div class="col-6">
                                <div class="form-group form-anggota">
                                    ...
                                    <div class="form-check">
                                      <input class="form-check-input status-nikah" type="radio" {{ $warga->status_perkawinan == "Menikah" ? 'checked' : '' }} checked value="Menikah" name="status_perkawinan" id="status1" required>
                                      <label class="form-check-label" for="status1">
                                        Menikah
                                      </label>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input status-nikah" type="radio" {{ $warga->status_perkawinan == "Lajang" ? 'checked' : '' }}  value="Lajang" name="status_perkawinan" id="status2">
