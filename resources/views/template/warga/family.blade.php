        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Tambah Anggota Keluarga</div>
                </div>
            </div>

            {{-- edit content --}}
            <div class="card">
                <form class="needs-validation" novalidate="" method="POST" action="{{ route('warga.postFamily') }}">
                    @csrf
                    <div class="card-header">
                      <h4>Form Tambah Anggota Keluarga</h4>
                    </div>
                    <div class="container">
                        @error('nik')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ $warga->nama_warga }}" readonly>
                            <input type="text" name="wargas_id" value="{{ $warga->id }}" id="" hidden>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Namanya siapa?</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
